...
class CCS_Content {
	...
	public static function content_shortcode( $atts ) {
		...
		$current_post = $post; // Current post by default
...
//			'status' => null,
	...
	*/
		 ...
		 *
		 * Optimize: get field value only as necessary
		 *
		 *=======================================================================*/
	...
	*/			if(!empty($class))
		...
		if ($custom_field == '') { 
			...
			if ($taxonomy != '') { // Taxonomy query?
				...
				// Format and embed enabled by default for post content
			...
			/*========================================================================
			 *
			 * If current post is an attachment (or gallery field item)
			 *
			 *=======================================================================*/
